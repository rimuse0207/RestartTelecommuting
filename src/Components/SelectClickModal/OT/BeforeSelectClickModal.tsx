...
import PrinterBeforeSelectClickModal from './PrinterBeforeSelectClickModal';
...
const BeforeSelectClickModal = ({ clicksTitle, clicksData, modalClose }: TeleSelectClickModalProps) => {
...
export default BeforeSelectClickModal;
