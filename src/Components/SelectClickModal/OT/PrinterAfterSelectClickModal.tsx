...
const PrinterCssMianPage = styled.div`
    @page {
        background: none;
        size: A4;
        width: 420mm;
...
const PrinterAfterSelectClickModal = ({ printerClicked, clicksData, setPrinterClicked }: PrinterAfterSelectClickModalProps) => {
    function closeModal() {
...
export default PrinterAfterSelectClickModal;
