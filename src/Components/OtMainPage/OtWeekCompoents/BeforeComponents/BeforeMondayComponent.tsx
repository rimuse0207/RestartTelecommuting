...
const BeforeMondayComponent = ({ monDateData, setMonDateData, startDate }: OtMonComponentsProps) => {
    return (
        <>
            <tr>
                ...
                <td rowSpan={3} width="100px">
                    {monDateData.holidayCheck === 'weekday' ? (
...
export default React.memo(BeforeMondayComponent);
