...
import { PrinterButtonContainer } from './BeforeOtTeamLeaderFinish';
            ...
            <table>
                <thead>
                    ...
                    >
                        ...
                        <th className="OTSpace_OTReason_th" rowSpan={2}>
                            연장 사유
                        </th>
                    </tr>
                    <tr
            ...
            <PrinterButtonContainer>
                <div className="WeekAfterOTWorkSpace_store_button_div">
                    <button
                        onClick={() =>
                            window.open(
                                `/PrinterTest/after/${startDate.clone().format('YYYY-MM-DD')}/${id}`,
                                'AfterOT',
...
export default AfterOtTeamLeaderFinish;
