...
type TeamLeaderAfterOTWorkSpaceProps = {
    selectYear: string;
    selectMonth: string;
...
const TeamLeaderAfterOTWorkSpace = ({ selectYear, selectMonth, selectName }: TeamLeaderAfterOTWorkSpaceProps) => {
    const [BeforeOTData, setBeforeOTData] = useState<any>([]);
    const [AfteronClicked, setAfteronClicked] = useState(false);
    ...
    const modalClose = () => {
        setAfteronClicked(false);
    };
    const getDataOTData = async () => {
        try {
            const getDataBeforeOT = await axios.post(`${process.env.REACT_APP_DB_HOST}/TeamSelectOT_app_server/getPersonAfterOT`, {
                selectYear,
                selectMonth,
                selectName,
            });
    ...
    return (
        <div>
            ...
            <TeamLeaderAfterModal
                onClicked={AfteronClicked}
...
export default TeamLeaderAfterOTWorkSpace;
