...
const TeamLeaderBeforeOTWorkSpace = ({ selectYear, selectMonth, selectName }: TeamLeaderBeforeOTWorkSpaceProps) => {
    ...
    return <div>
                ...
                <div>
                    ...
                    {BeforeOTData.map((list:listType)=>{
                        return <tr>
                                ...
                                <td className="TeamLeader_before_OT_WorkSpace_click_td" onClick={()=>{
                                    setonClicked(true)
        ...
        <TeamLeaderModal onClicked={onClicked} modalClose={modalClose} clickedOTData={clickedOTData}></TeamLeaderModal>
    </div>;
};
